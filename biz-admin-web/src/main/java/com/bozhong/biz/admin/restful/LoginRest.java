package com.bozhong.biz.admin.restful;

import com.bozhong.biz.admin.common.BizAdminConstants;
import com.bozhong.biz.admin.common.BizAdminErrorEnum;
import com.bozhong.biz.admin.util.RSAHelper;
...
public class LoginRest {
    ...
    public String checkLogin(@Context Request request, @Context UriInfo uriInfo, @Context HttpHeaders httpHeaders) {
        ...
        try {
            PrivateKey privateKey = RSAHelper.getPrivateKey((String) keyMap.get(BizAdminConstants.PRIVATE_KEY));
